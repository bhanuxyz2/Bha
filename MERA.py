...
FEEDBACK_CHANNEL = "@@feedbackme09"
PAID_CHANNEL = "@@VIPPAIDMOD09"
CONTACT_ADMINS = ["@bhanuxyz2"]
...
def handle_broadcast(message):
    ...
    formatted_msg = (
        ...
        "═══════════════════════\n"
        "🔥 Join: @VIPPAIDMOD09\n"
        f"📞 Contact: {@BHANUXYZ2[0]} or {@BHANUXYZ2[1]}\n"
...
🌟 Join {@VIPPAIDMOD09} for premium features!
"""
...
🔥 Join @VIPPAIDMOD09 & @@feedbackme09 to use!
        ...
        if user['attacks'] >= ATTACK_LIMIT:
            ...
            if user['attacks'] >= total_allowed_attacks:
                promotion_msg = (
                    ...
                    f"💎 Join {@VIPPAIDMOD09} for unlimited attacks!\n"
                    f"📩 Invite more friends to {@VIPPAIDMOD09} for +1 attack per invite!\n"
                    f"🔥 DM {@BHANUXYZ2[0]} or {BHANUXYZ2[1]} for premium access!\n"
...
⚡ Dominate the web!
🔗 Join: {@VIPPAIDMOD09}
💎 Premium: {@VIPPAIDMOD09}
📞 Help: {@BHANUXYZÈ[0]}, {@BHANUXYZ2[1]}
"""
    bot.reply_to(message, response)
