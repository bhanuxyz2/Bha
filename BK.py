...
TOKEN = '7635879265:AAEawuoOwXg2CF7u_i_qLV6_XA4ZfjiWBjI'  # Replace with your actual bot token
ADMIN_IDS = [6240986259]  # Added new admin ID
CHANNEL_ID = '-1002592395410'  # Replace with your specific channel or group ID
# Initialize the bot
...
def welcome_start(message):
    ...
    bot.send_message(
            message.chat.id,
            f"👋🏻Welcome {user_name}.\n\n"
            f"[➖ 𝗖𝗟𝗜𝗖𝗞 𝗛𝗘𝗥𝗘 𝗧𝗢 𝗝𝗢𝗜𝗡 ➖](https://t.me/VIPPAIDMOD09)\n\n"    
    ...
    bot.send_message(
            message.chat.id,
            f" [➖𝗗𝗠 𝗙𝗢𝗥 𝗥𝗘𝗕𝗥𝗔𝗡𝗗𝗜𝗡𝗚➖](https://t.me/VIPPAIDMOD09)\n\n                                                      ↖️",
    parse_mode="Markdown",
    disable_web_page_preview=True  # This disables the link preview
    )
...
def info(message):
    info_text = (
        "ℹ️ *Bot Information*\n\n"
        "Version: 3.0\n"
        "Developed And Design by: @bhanuxyz2\n"
...
def reset_attack_limit(message):
    owner_id = 6240986259  # Replace with the actual owner ID
    ...
    response = (
        ...
        "━━━━━━━━━━━━━━━━━━━\n"
        "🔗 *𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬: [BHANU](https://t.me/VIPPAIDMOD09) ⚡*"
    )
...
FEEDBACK_CHANNEL_ID = "-1002325438025"  # Replace with your actual feedback channel ID
...
def bgmi_command(message):
    ...
    try:
        ...
        if user_status not in ["member", "administrator", "creator"]:
            bot.send_message(
                ...
                f" [➖ 𝗖𝗟𝗜𝗖𝗞 𝗛𝗘𝗥𝗘 𝗧𝗢 𝗝𝗢𝗜𝗡 ➖](https://t.me/feedbackme09)\n\n"
    ...
    try:
        ...
        logging.info(f"Attack started by {user_name}: ./lala {target_ip} {target_port} {default_duration}")
